...
static const Rectangle LEVEL_CLEAR_BG_RECTANGLE = { 155, 90, 170, 90 };
static const Color     LEVEL_CLEAR_BG_COLOUR    = { 64, 64, 64, 200 };
static const Color     LEVEL_CLEAR_BG_BORDER    = { 255, 255, 255, 200 };

static const Rectangle GAME_WON_BG_RECTANGLE = { 140, 90, 200, 90 };
...
void draw_levelClear(void) {
  ...
  draw_shadowText(LEVEL_TIME_TEXT, data.time);
