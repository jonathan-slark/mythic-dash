...
float           asset_getWailVolume(int id);
float           asset_getChimeVolume(void);
float           asset_getDeathVolume(void);
float           asset_getFallingVolume(void);
float           asset_getWhispersVolume(void);
float           asset_getPickupVolume(void);
float           asset_getTwinkleVolume(void);
float           asset_getWinVolume(void);
float           asset_getGameOverVolume(void);
float           asset_getLifeVolume(void);
float           asset_getResVolume(void);
